#ifndef GD_PROC_LINE_H
#define GD_PROC_LINE_H

#include "gdprocnode.h"

namespace godot {

class GDProcLine : public GDProcNode {
	GODOT_SUBCLASS(GDProcLine, GDProcNode)
...
public:
	...
	void set_vector(Vector3 p_vector);
