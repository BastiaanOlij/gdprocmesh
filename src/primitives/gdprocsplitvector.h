#ifndef GD_PROC_SPLIT_VECTOR_H
#define GD_PROC_SPLIT_VECTOR_H

#include "gdprocnode.h"

namespace godot {

class GDProcSplitVector : public GDProcNode {
	GODOT_SUBCLASS(GDProcSplitVector, GDProcNode)

private:
	Vector3 default_vector;
	PoolRealArray output_x;
	PoolRealArray output_y;
	PoolRealArray output_z;
