#ifndef GD_PROC_VEC3_BEVEL_H
#define GD_PROC_VEC3_BEVEL_H

#include "gdprocnode.h"

namespace godot {

class GDProcVec3Bevel : public GDProcNode {
	GODOT_SUBCLASS(GDProcVec3Bevel, GDProcNode)
