#ifndef GD_PROC_RAYCAST_H
#define GD_PROC_RAYCAST_H

#include "gdprocnode.h"

namespace godot {

class GDProcRaycast : public GDProcNode {
	GODOT_SUBCLASS(GDProcRaycast, GDProcNode)

private:
	Vector3 default_ray;
	float default_offset;
	PoolVector3Array values;
