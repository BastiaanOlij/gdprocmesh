#ifndef GD_PROC_INVECTOR_H
#define GD_PROC_INVECTOR_H

#include "gdprocnode.h"

namespace godot {

class GDProcInVector : public GDProcNode {
	GODOT_SUBCLASS(GDProcInVector, GDProcNode)
