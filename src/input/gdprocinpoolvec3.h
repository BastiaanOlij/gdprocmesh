#ifndef GD_PROC_INPOOLVEC3_H
#define GD_PROC_INPOOLVEC3_H

#include "gdprocnode.h"

namespace godot {

class GDProcInPoolVec3 : public GDProcNode {
	GODOT_SUBCLASS(GDProcInPoolVec3, GDProcNode)
